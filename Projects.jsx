...
import MyPhoto3 from 'file:///C:/Users/Tom/Desktop/code2.png';
      ...
      <div>
        ...
        <main className='min-h-screenr'>
          <div className='flex h-screen items-center justify-evenly'>
            ...
            <div class="text-7xl text-left text-white font-bold">
              ...
              <div className='text-xl text-left'>Graded a Merit</div>
              <Link href='/2D'>
                <button class="mt-2 rounded-lg bg-neutral-800 py-1 px-2 text-sm hover:bg-Pink hover:text-black">Read More</button>
              </Link>
            </div>
          ...
          <div className='flex h-screen items-center justify-evenly'>
            <div className='flex items-center justify-around h-150 w-200 hover:bg-gradient-to-r from-Gray2 from-30% to-Gray1 to-70% bg-opacity-10 shadow-lg rounded'>
            <div class="text-5xl text-right text-white font-bold">
              ...
              <div className='text-xl text-right'>Graded a Merit</div>
              
              <Link href='/Esports'>
                <button class="right mt-2 rounded-lg bg-neutral-800 py-1 px-2 text-sm hover:bg-Pink hover:text-black">Read More</button>
              </Link>
            </div>
            <div class="p-5 w-140">
          ...
          <div className='flex h-screen items-center justify-evenly '>
            <div className='flex items-center justify-around h-150 w-200 hover:bg-gradient-to-r from-Gray2 from-30% to-Gray1 to-70% bg-opacity-10 shadow-lg rounded'>
              <div class="flex p-5 w-145 items-center">
              <Image src={MyPhoto3} class="shadow-lg rounded max-w-full h-145 align-middle border-none object-cover h-1279 w-96" /> 
              </div>
            <div class="text-6xl text-left text-white font-bold">
              <p>Bouncing Images Project</p>
              <div className='text-4xl text-left'>The outcome was to create a web page with one or more images that bounce around the screen.</div>
              <div className='text-xl text-left'>Graded a Pass</div>
